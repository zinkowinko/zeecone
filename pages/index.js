...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white px-6">
      {/* Hero Section */}
      <section className="text-center spacing-large">
        <motion.h1
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-gray-800 py-20 px-6 w-full">
          ...
          <div className="flex justify-center gap-6 mt-8">
            ...
            <a href="https://discord.com/users/1215148880052625478" target="_blank" aria-label="Discord">
              <img
                ...
                alt="Discord"
                className="w-8 h-8 hover:opacity-75 transition-all"
              />
            </a>
          </div>
        </div>
